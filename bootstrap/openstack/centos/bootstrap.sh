...
#apt-add-repository 'deb http://pkg.tuleap.net/debian tuleap-dev main'
#apt-get -qy update
#apt-get -qy --force-yes install tuleap-archive-keyring
#apt-get -qy update
#apt-get -qy upgrade
#

# Do NOT update/upgrade here, it breaks cloud-init
#yum -qy update
